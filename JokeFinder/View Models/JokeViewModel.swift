...
class JokeViewModel {
    ...
    func fetchJoke() async {
        ...
        guard let url = URL(
            ...
            print(
                "Invalid address for JSON endpoint."
            )
            return
        }
        ...
        do {
            ...
            print(
                "Got data from endpoint, contents of response are:"
            )
            print(
                String(
                    data: data,
            ...
            print(
                "Count not retrieve data from endpoint, or could not decode into an instance of a Swift data type."
            )
            print(
                "----"
            )
